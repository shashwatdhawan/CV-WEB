...
let storeData = { discordLink: "https://discord.gg/8ZucR4fXkk", categories: {}, products: [] };
...
const productBadges = {
  ...
  "coins-2500": "Popular",
  "coins-5000": "Value",
  "coins-8000": "Great Deal",
  "coins-15000": "Mega",
  "coins-25000": "Best Value",
  "cloud-key": "Popular",
  "matrix-key": "New",
  "amethyst-key": "Spawner",
...
const validTabs = ["home", "store", "voting", "feedback"];
...
tabLinks.forEach(link => {
  link.addEventListener("click", event => {
    ...
    showTab(link.dataset.tab || "home");
    if (navCenter && menuButton) {
...
const initialTab = currentHash === "products" ? "store" : (validTabs.includes(currentHash) ? currentHash : "home");
showTab(initialTab, { updateHash: false, scroll: false });

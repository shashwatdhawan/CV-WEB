...
class Settings:
    ...
    website_bot_url: str | None = os.getenv("WEBSITE_BOT_URL")
    website_ticket_secret: str | None = os.getenv("WEBSITE_TICKET_SECRET")
    discord_invite_url: str = os.getenv("DISCORD_INVITE_URL", "https://discord.gg/jWDH4GYuns")
